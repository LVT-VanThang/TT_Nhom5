		...
		<main class="main-content">
			...
			<div class="stats">
				...
				<div class="stat-box blue">
					🧑‍💼<br>Tổng số độc giả<br>
					<strong>340</strong>
				</div>
				<div class="stat-box orange">
					🔄<br>Sách đang mượn<br>
					<strong>75</strong>
				</div>
				<div class="stat-box red">
					⚠️<br>Sách quá hạn<br>
					<strong>8</strong>
				</div>
			</div>
			...
			<div class="alert-list">
				...
				<p>
					<strong>Tên sách:</strong> Nhà Giả Kim
				</p>
				<p>
					<strong>Độc giả:</strong> Nguyễn Văn A
				</p>
				<p>
					<strong>Ngày hẹn trả:</strong> 20/10/2025
				</p>
			</div>
		</main>
	</div>
